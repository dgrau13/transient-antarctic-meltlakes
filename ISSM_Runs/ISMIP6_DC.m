%DRY CREVASSE (DC)----ISSM RUN Script 
...
coresrequested =12;
memrequested = 16; %GB
timesrequested = 60*24*2; %minutes
...
if perform(org,'ISMIP6TransientCrevasse')
md = loadmodel(org,'Antarctic2.RunUKESM_SSP585Calving');
load("/storage/project/r-arobel3-0/dgrau7/ISSM_Runs/surface_snow_melt_UKESM1-0-LL_1850-2300_ISMIP6Mesh.mat")
...
md.calving.water_height = zeros(md.mesh.numberofvertices,1);
md.settings.solver_residue_threshold = 1000;
md.levelset.reinit_frequency = 1;
md.miscellaneous.name = 'TransientCrevasse';
